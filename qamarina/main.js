...
setupCountdown(".campaign-0", new Date().getMilliseconds(), 1774118400000);
...
const generateEventFor = {
    info: {
        title: "Jemputan Kenduri Kahwin Qamarina & Sharul",
        startDate: "20260322T040000Z", // YYYYMMDDTHHmmssZ (UTC)
        endDate: "20260322T100000Z",
        location: "Lot 2274 A Kampung Bukit Marak, 16150 Kota Bharu, Kelantan",
